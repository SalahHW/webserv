...
IndexDirective::IndexDirective(Block *currentContext,
...
IndexDirective::IndexDirective(const IndexDirective &other)
    : Directive(other), indexPath(other.indexPath) {}
...
const std::string &IndexDirective::getIndexPath() const { return indexPath; }